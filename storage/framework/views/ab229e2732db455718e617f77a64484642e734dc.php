...
<form action="<?php echo e(action('PublicationPlanController@update', $plan->id)); ?>" method="POST">
            ...
            <select class="selectpicker" data-show-subtext="true" data-live-search="true" name="type_publication_id" data-width="100%">
                ...
                <?php $__currentLoopData = $type_publication; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($value->id == $plan->type_publication_id): ?>
                        <option selected value="<?php echo e($value->id); ?>" ><?php echo e($value->type_publication_name); ?></option>
                    <?php else: ?>
    ...
    <div class="form-group">
        ...
        <input class="form-control" id="namePublication" type="text" name="name_of_publication" value="<?php echo e($plan->name_of_publication); ?>">
    </div>
    ...
    <div class="form-group">
        ...
        <input class="form-control" type="text" name="number_of_pages" type="text" name="number_of_pages" value="<?php echo e($plan->number_of_pages); ?>">
    </div>

    <div class="form-group">
        <label for="numberCopies">Тираж</label>
        <input class="form-control" type="text" name="number_of_copies" id="numberCopies" value="<?php echo e($plan->number_of_copies); ?>">
    </div>
    ...
    <div class="form-group">
        ...
        <div class="row-fluid">
            <input class="form-control" type="text" name="year_of_publication" value="<?php echo e($plan->year_of_publication); ?>">
        </div>
    </div>

    <div class="form-group">
        <label for="numberPhone">Номер телефона</label>
        <input class="form-control" type="text" name="phone_number" id="numberPhone" value="<?php echo e($plan->phone_number); ?>">
    </div>
