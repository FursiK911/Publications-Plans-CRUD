                    ...
                    <?php if(Route::has('login')): ?>
                        <div class="top-right links">
                            <?php if(auth()->guard()->check()): ?>
                                <li class="nav-item">
                                    <label class="btn btn-secondary">
                                        <a class="nav-link" onclick="<?php echo e(\Illuminate\Support\Facades\Auth::logout()); ?>">Выйти</a>
                                    </label>
                                </li>
                            <?php else: ?>
                                <li class="nav-item">
...
</html><?php /**PATH W:\domains\Coursework\resources\views/plans/layouts/layout.blade.php ENDPATH**/ ?>