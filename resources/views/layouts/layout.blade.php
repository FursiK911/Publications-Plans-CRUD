            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown2">
                        ...
                        <a class="dropdown-item" href="{{ asset('select-table-for-remove-from-base') }}">Удалить из
                            базы</a>
                    </div>
                </li>
                @endrole
                ...
                @if (Auth::user() != null)
                    <div class="top-right links">
                        <li class="nav-item">
                            <label class="btn btn-secondary">
                                <a class="nav-link" href="">Вы зашли под именем {{\Illuminate\Support\Facades\Auth::user()->last_name}} {{\Illuminate\Support\Facades\Auth::user()->name}} {{\Illuminate\Support\Facades\Auth::user()->middle_name}}
                                </a>
                            </label>
                        </li>
                    </div>
